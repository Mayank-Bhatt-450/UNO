...
def uno():
    ...
    while True:
        ...
        try:
            ...
            prn(f'uno break can"t find{username}')
            gameloop_flag=True
            break
...
def gameloop():
    ...
    global deck,ldeck,screen,hand_cards_list,bg,gameloop_flag
    socket()
    gameloop_flag=False
    running=True
    flg=''
    while running:#main loop
        event_is=pygame.event.get()
        if gameloop_flag:

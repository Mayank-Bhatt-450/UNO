...
def gunoturn():
    global game_states,num_of_players,username,screen,back_img
    #prn(game_states)
    if game_states!={}:
        ...
        for i in range(num_of_players):
            ...
            if  plr!=username:
                ...
                name_tag_pos=(placeholder_name[0]-155,placeholder_name[1]-75)
                if game_states[plr]['turn']=='true':
                    screen.blit(turn_img,(name_tag_pos[0]-30,name_tag_pos[0]-55))
                ...
                places=fontx.render(plr,True,(0,0,0))
                w=places.get_width()
                h=places.get_height()
                screen.blit(places,(
